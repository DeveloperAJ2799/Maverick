...
```text
[order-report] working directory: /path/to/mavrick
...
[order-report] reproduce with: /path/to/mavrick/venv/bin/python /path/to/mavrick/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
