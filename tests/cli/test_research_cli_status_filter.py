"""`mavrick-research list --status complete` was returning nothing.
...
Part of #2122 (mavrick-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "mavrick-research"
    loader = importlib.machinery.SourceFileLoader("mavrick_research_cli", str(path))
