...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/mavrick/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/mavrick/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Mavrick's existing visual language. Specifically:
