...
# Override at deploy time via `MAVRICK_FALLBACK_OWNER` env var. In a real
# multi-user install set `MAVRICK_SINGLE_USER=0` so unauthenticated requests
# are rejected instead of silently writing to this address.
import os as _os
FALLBACK_OWNER = _os.environ.get("MAVRICK_FALLBACK_OWNER", "owner@localhost")
_SINGLE_USER_MODE = _os.environ.get("MAVRICK_SINGLE_USER", "1") != "0"
