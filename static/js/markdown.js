...
function initMermaid() {
  if (!window.mermaid || window.__mavrickMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__mavrickMermaidReady = true;
}
window.mavrickInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'mavrick-thinking-expanded';
