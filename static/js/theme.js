...
const LS_KEY = 'mavrick-theme';
const CUSTOM_THEMES_KEY = 'mavrick-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Mavrick Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'mavrick-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'mavrick_' + (obj.name || 'theme') + '.json';
      a.click();
