...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'mavrick-model-expanded',
  MODEL_ENDPOINTS: 'mavrick-model-endpoints',
  MODEL_SELECTED: 'mavrick-selected-model',
  SORT_ORDER: 'mavrick-sessions-sort',
  CHAT_SEARCH_SCOPE: 'mavrick-search-scope',
  INCOGNITO: 'mavrick-incognito',
  RAG_ACTIVE: 'mavrick-rag-active',
  MCP_ACTIVE: 'mavrick-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'mavrick-density',
  UI_SCALE: 'mavrick-ui-scale',
  WORKSPACE: 'mavrick-workspace'
};
