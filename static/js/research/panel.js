...
const _RESEARCH_HINTS = [
  "e.g. Trace Mavrick's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him",
...
const _SETTINGS_KEY = 'mavrick-research-settings';
const _COLLAPSE_KEY = 'mavrick-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('mavrick-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
