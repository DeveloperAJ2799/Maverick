...
Imports MemoryManager and MemoryVectorStore from the Mavrick codebase.
"""
...
_OWNER_ENV_KEYS = ("MAVRICK_MCP_MEMORY_OWNER", "MAVRICK_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set MAVRICK_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
