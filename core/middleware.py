...
INTERNAL_TOOL_TOKEN = os.environ.get("MAVRICK_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Mavrick-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Mavrick-Internal-Token), or
