...
This helper is intentionally read-only. It does not import the Mavrick
application package, write to data/, call an LLM, or apply anything. It turns
common agent export shapes into a portable JSON manifest that Mavrick can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral Mavrick agent migration manifest.")
