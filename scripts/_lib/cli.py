"""scripts/_lib/cli.py — shared scaffolding for the `mavrick-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("mavrick-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/mavrick-foo`
...
VERSION = "0.1.0"  # bumped centrally; every mavrick-* CLI reports this
