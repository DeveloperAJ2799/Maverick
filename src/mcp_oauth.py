...
Registration, authorization-code + PKCE, token refresh) to Mavrick's web
...
# on Mavrick. APP_PORT is intentionally not used: it is only the Docker host
