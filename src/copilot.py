...
COPILOT_USER_AGENT = os.environ.get(
    "MAVRICK_COPILOT_USER_AGENT", "Mavrick/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "MAVRICK_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "MAVRICK_COPILOT_EDITOR_VERSION", "Mavrick/1.0"
)
